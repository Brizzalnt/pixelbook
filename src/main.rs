        ...
        Ok(data) => {
            ...
            for (i, item) in data.iter().enumerate() {
                ...
                if indexer == 3{
                    ...
                    drawNibbGlow(arraystore[0],arraystore[1],arraystore[2],glow_c,glow_m,glow_y,glow_k);
...
fn drawNibbGlow(ux:u32,uy:u32,uz:u32,uc:f32,um:f32,uy2:f32,uk:f32)  -> Result<(), Box<dyn std::error::Error>> {
    let mut filepath = "";
    filepath = "glow.nibb";
    let separator = ','; 
        ...
        Ok(data) => {
            for (i, item) in data.iter().enumerate() {
                ...
                if indexer == 8{
                    ...
                    creator(arraystore[0]as u32+offset_x,arraystore[1]as u32+offset_y,arraystore[2]as u32,uc,um,uy2,uk,arraystore[7]);
